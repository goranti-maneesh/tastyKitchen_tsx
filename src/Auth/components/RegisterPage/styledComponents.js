...
export const FormSection = styled.div`
    ${tw`w-1/2 h-screen flex justify-center items-center p-4`}
`;
...
export const SignupPageImg = styled.img`
    ${tw`w-full h-full`}
`;

export const SignupPageTopSection = styled.div`
